...
public class ArrayLs {
	...
	public static void main(String[] args) {
		...
		System.out.println("abridgement before sort: " + abridgement[0]);
		Arrays.sort(abridgement);
		System.out.println("abridgement after sort: " + abridgement[0]);
